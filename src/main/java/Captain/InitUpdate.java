...
<<<<<<< Updated upstream
        GameObject obj213_skyblock = new GameObject("Object sky", new Transform(new Vector2f(-120, 1490), new Vector2f(48, 48)));
        obj213_skyblock.addComponent(new SpriteRenderer(sprites_town.getSprite(140)));
        this.addGameObjectToScene(obj213_skyblock);

        GameObject obj213_skyblock_ed = new GameObject("Object sky", new Transform(new Vector2f(-30, 1570), new Vector2f(48, 48)));
        obj213_skyblock_ed.addComponent(new SpriteRenderer(sprites_town.getSprite(140)));
        this.addGameObjectToScene(obj213_skyblock_ed);
=======
        GameObject obj213_skyblock = new GameObject("Object sky", new Transform(new Vector2f(0, 1450), new Vector2f(48, 48)));
        obj213_skyblock.addComponent(new SpriteRenderer(sprites_town.getSprite(140)));
        this.addGameObjectToScene(obj213_skyblock);
>>>>>>> Stashed changes
//
...
//        this.addGameObjectToScene(obj132_sky);
        ...
        GameObject obj347_sky = new GameObject("Object sky", new Transform(new Vector2f(400, 1156), new Vector2f(199, 199)), false, true);
...
//        this.addGameObjectToScene(obj345_sky);
        ...
        GameObject obj348_sky = new GameObject("Object sky", new Transform(new Vector2f(-140, 1220), new Vector2f(48, 48)));
...
//        this.addGameObjectToScene(obj355_sky);
        ...
        GameObject obj356_sky = new GameObject("Object sky", new Transform(new Vector2f(-40, 1300), new Vector2f(48, 48)));
        obj356_sky.addComponent(new SpriteRenderer(sprites_town.getSprite(140)));
        this.addGameObjectToScene(obj356_sky);

        GameObject obj357_sky = new GameObject("Object sky", new Transform(new Vector2f(70, 1350), new Vector2f(48, 48)));
...
//        this.addGameObjectToScene(obj358_sky);
        ...
        GameObject obj359_sky = new GameObject("Object sky", new Transform(new Vector2f(-40, 1420), new Vector2f(48, 48)));
...
//        this.addGameObjectToScene(obj392_sky);
        ...
        GameObject obj393_sky = new GameObject("Object sky", new Transform(new Vector2f(190, 1750), new Vector2f(48, 48)));
...
//        this.addGameObjectToScene(obj479_sky);
        ...
        GameObject obj481_sky = new GameObject("Object sky", new Transform(new Vector2f(96, 2730), new Vector2f(48, 48)));
...
//        this.addGameObjectToScene(obj492_sky);
        ...
        GameObject obj494_sky = new GameObject("Object sky", new Transform(new Vector2f(480, 2710), new Vector2f(48, 48)));
        obj494_sky.addComponent(new SpriteRenderer(sprites_forest.getSprite(30)));
        this.addGameObjectToScene(obj494_sky);

        GameObject obj494_sky_ed = new GameObject("Object sky", new Transform(new Vector2f(270, 2710), new Vector2f(48, 48)));
        obj494_sky_ed.addComponent(new SpriteRenderer(sprites_forest.getSprite(30)));
        this.addGameObjectToScene(obj494_sky_ed);

        GameObject obj495_sky_ed = new GameObject("Object sky", new Transform(new Vector2f(630, 2670), new Vector2f(48, 48)));
        obj495_sky_ed.addComponent(new SpriteRenderer(sprites_forest.getSprite(30)));
        this.addGameObjectToScene(obj495_sky_ed);

        GameObject obj496_sky_ed = new GameObject("Object sky", new Transform(new Vector2f(740, 2700), new Vector2f(48, 48)));
        obj496_sky_ed.addComponent(new SpriteRenderer(sprites_forest.getSprite(30)));
        this.addGameObjectToScene(obj496_sky_ed);

        GameObject obj497_sky_ed = new GameObject("Object sky", new Transform(new Vector2f(860, 2700), new Vector2f(48, 48)));
        obj497_sky_ed.addComponent(new SpriteRenderer(sprites_forest.getSprite(30)));
        this.addGameObjectToScene(obj497_sky_ed);

        GameObject obj498_sky_ed = new GameObject("Object sky", new Transform(new Vector2f(950, 2780), new Vector2f(48, 48)));
        obj498_sky_ed.addComponent(new SpriteRenderer(sprites_forest.getSprite(30)));
        this.addGameObjectToScene(obj498_sky_ed);
...
//        this.addGameObjectToScene(obj15_ev);
        ...
        GameObject obj16_ev = new GameObject("Object ev", new Transform(new Vector2f(1140, 568), new Vector2f(199, 199)), false, true);
        obj16_ev.addComponent(new SpriteRenderer(treeset.getSprite(0)));
        this.addGameObjectToScene(obj16_ev);

        GameObject obj17_ev = new GameObject("Object sky", new Transform(new Vector2f(300, 1156), new Vector2f(48, 48)), false, true);
        obj17_ev.addComponent(new SpriteRenderer(sprites_forest.getSprite(64)));
        this.addGameObjectToScene(obj17_ev);

        GameObject obj18_ev = new GameObject("Object sky", new Transform(new Vector2f(230, 1156), new Vector2f(48, 48)), false, true);
...
//        this.addGameObjectToScene(obj21_ev);
        ...
        GameObject obj22_ev = new GameObject("Object sky", new Transform(new Vector2f(260, 1156), new Vector2f(48, 48)), false, true);
        obj22_ev.addComponent(new SpriteRenderer(sprites_forest.getSprite(63)));
        this.addGameObjectToScene(obj22_ev);

        GameObject obj23_ev = new GameObject("Object sky", new Transform(new Vector2f(250, 1156), new Vector2f(48, 48)), false, true);
        obj23_ev.addComponent(new SpriteRenderer(sprites_forest.getSprite(62)));
        this.addGameObjectToScene(obj23_ev);

        GameObject obj24_ev = new GameObject("Object sky", new Transform(new Vector2f(590, 1156), new Vector2f(199, 199)), false, true);
        obj24_ev.addComponent(new SpriteRenderer(treeset.getSprite(1)));
        this.addGameObjectToScene(obj24_ev);

        GameObject obj25_ev = new GameObject("Object sky", new Transform(new Vector2f(430, 1156), new Vector2f(48, 48)), false, true);
        obj25_ev.addComponent(new SpriteRenderer(sprites_forest.getSprite(62)));
        this.addGameObjectToScene(obj25_ev);

        GameObject obj26_ev = new GameObject("Object sky", new Transform(new Vector2f(490, 1156), new Vector2f(48, 48)), false, true);
        obj26_ev.addComponent(new SpriteRenderer(sprites_forest.getSprite(62)));
        this.addGameObjectToScene(obj26_ev);

        GameObject obj27_ev = new GameObject("Object sky", new Transform(new Vector2f(1500, 2212), new Vector2f(48, 48)), false, true);
        ...
        GameObject obj30_ev = new GameObject("Object sky", new Transform(new Vector2f(700, 2868), new Vector2f(48, 48)), false, true);
        obj30_ev.addComponent(new SpriteRenderer(sprites_forest.getSprite(62)));
        this.addGameObjectToScene(obj30_ev);

        GameObject obj31_ev = new GameObject("Object sky", new Transform(new Vector2f(540, 2868), new Vector2f(48, 48)), false, true);
        obj31_ev.addComponent(new SpriteRenderer(sprites_forest.getSprite(63)));
        this.addGameObjectToScene(obj31_ev);

        GameObject obj32_ev = new GameObject("Object sky", new Transform(new Vector2f(780, 2868), new Vector2f(48, 48)), false, true);
        obj32_ev.addComponent(new SpriteRenderer(sprites_forest.getSprite(63)));
        this.addGameObjectToScene(obj32_ev);

        GameObject obj33_ev = new GameObject("Object sky", new Transform(new Vector2f(950, 2212), new Vector2f(199, 199)), false, true);
        obj33_ev.addComponent(new SpriteRenderer(treeset.getSprite(0)));
        this.addGameObjectToScene(obj33_ev);

        GameObject obj34_ev = new GameObject("Object sky", new Transform(new Vector2f(1120, 2212), new Vector2f(48, 48)), false, true);
        obj34_ev.addComponent(new SpriteRenderer(sprites_forest.getSprite(63)));
        this.addGameObjectToScene(obj34_ev);

        GameObject obj35_ev = new GameObject("Object sky", new Transform(new Vector2f(1090, 2212), new Vector2f(48, 48)), false, true);
        obj35_ev.addComponent(new SpriteRenderer(sprites_forest.getSprite(62)));
        this.addGameObjectToScene(obj35_ev);

        GameObject obj36_ev = new GameObject("Object sky", new Transform(new Vector2f(1040, 2212), new Vector2f(48, 48)), false, true);
        obj36_ev.addComponent(new SpriteRenderer(sprites_forest.getSprite(63)));
        this.addGameObjectToScene(obj36_ev);

        GameObject obj37_ev = new GameObject("Object sky", new Transform(new Vector2f(1240, 2212), new Vector2f(48, 48)), false, true);
...
<<<<<<< Updated upstream
<<<<<<< HEAD
        knightidle = new GameObject("knightc", new Transform(new Vector2f(-52, 2800), new Vector2f(50, 50)), true, false);
=======
        knightidle = new GameObject("knightc", new Transform(new Vector2f(-52, 157), new Vector2f(50, 50)), true, false);
>>>>>>> 37334752891ab3663797b973c098c9d9ca34cad8
=======
...
>>>>>>> 37334752891ab3663797b973c098c9d9ca34cad8
    ...
    public void update(float dt) {
        ...
        }if (knightidle.transform.position.y >= 1401 && knightidle.transform.position.y<1950){
            camera.position.y = 1400;

        }if (knightidle.transform.position.y >= 1951 && knightidle.transform.position.y<2100){
